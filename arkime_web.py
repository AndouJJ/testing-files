...
def _load_port_expectations():
    ...
    # Comprehensive protocol mappings from nDPI, Wikipedia, and common services
    arkime_extras = {
        ...
        "401": ["ups"],
        "427": ["svrloc", "slp"],
        "443": ["https", "tls", "ssl", "quic", "http"],
        "444": ["snpp"],
        "445": ["smb", "cifs", "microsoft-ds"],
        "464": ["kpasswd"],
        "465": ["smtps", "submissions", "tls", "ssl"],
        "475": ["tcpnethaspsrv"],
        "497": ["retrospect"],
        ...
        "2947": ["gpsd"],
        "2967": ["symantec"],
        "3000": ["grafana", "rails", "meteor"],
        "3001": ["honeywell"],
        "3004": ["isync"],
        "3020": ["cifs"],
        "3050": ["gds-db", "interbase"],
        "3052": ["apc"],
        "3074": ["xbox-live"],
        "3101": ["blackberry"],
        ...
        "5193": ["aim"],
        "5222": ["xmpp", "jabber"],
        "5223": ["xmpp", "jabber", "tls"],
        "5224": ["hpvmmcontrol"],
        "5225": ["hpvmmdata"],
        "5226": ["hpvmmdata"],
        "5228": ["gcm", "google-play"],
        "5242": ["viber"],
        "5243": ["viber"],
        "5269": ["xmpp-server"],
        "5280": ["xmpp-bosh"],
        ...
        "5298": ["presence"],
        "5310": ["outlaws"],
        "5349": ["stun-tls", "turn-tls"],
        "5351": ["nat-pmp"],
        "5353": ["mdns", "dns", "bonjour"],
        "5354": ["mdns"],
        "5355": ["llmnr"],
        "5357": ["wsd"],
        "5358": ["wsd-tls"],
        ...
        "6051": ["arcserve"],
        "6100": ["vino"],
        "6112": ["dtspcd", "battlenet", "guildwars"],
        "6113": ["battlenet"],
        "6222": ["radmind"],
        "6262": ["sybase"],
        "6343": ["sflow"],
        ...
        "6889": ["bittorrent"],
        "6890": ["bittorrent"],
        "6891": ["bittorrent", "windows-live"],
        "6901": ["windows-live"],
        "6969": ["bittorrent", "acmsoda"],
        "6970": ["rtp"],
        "7000": ["afs", "cassandra"],
        ...
        "8767": ["teamspeak"],
        "8768": ["sandvine"],
        "8800": ["sun-webservices"],
        "8843": ["unifi"],
        "8880": ["cddbp"],
        "8883": ["mqtt", "tls"],
        "8888": ["http-alt", "ddi-tcp", "sun-answerbook"],
        "8889": ["ddi-tcp"],
        "8983": ["solr"],
        ...
        "48080": ["http-alt"],
        "49151": ["reserved"],
        # Dynamic/Private ports (49152-65535) - common services
        "49152": ["dynamic"],
        "51413": ["bittorrent"],
        "51820": ["wireguard"],
        "51821": ["wireguard"],
    ...
    for port, extras in arkime_extras.items():
        if port not in expectations:
            expectations[port] = []
        for proto in extras:
...
def _load_port_info_for_html():
    ...
    # Comprehensive protocol descriptions for HTML reference page
    arkime_extras = {
        # Well-known ports (0-1023)
        "7": {"services": ["echo"], "desc": "Echo Protocol - network testing"},
        "9": {"services": ["discard", "wake-on-lan"], "desc": "Discard/Wake-on-LAN"},
        "20": {"services": ["ftp-data"], "desc": "FTP data transfer channel"},
        "21": {"services": ["ftp"], "desc": "FTP control - file transfer"},
        "22": {"services": ["ssh", "sftp", "scp"], "desc": "SSH - secure remote login/file transfer"},
        "23": {"services": ["telnet"], "desc": "Telnet - unencrypted remote login"},
        "25": {"services": ["smtp"], "desc": "SMTP - email relay"},
        "37": {"services": ["time"], "desc": "Time Protocol"},
        "43": {"services": ["whois"], "desc": "WHOIS - domain lookup"},
        "49": {"services": ["tacacs"], "desc": "TACACS - authentication"},
        "53": {"services": ["dns"], "desc": "DNS - hostname resolution"},
        "67": {"services": ["dhcp", "bootp"], "desc": "DHCP/BOOTP server"},
        "68": {"services": ["dhcp", "bootp"], "desc": "DHCP/BOOTP client"},
        "69": {"services": ["tftp"], "desc": "TFTP - simple file transfer"},
        "70": {"services": ["gopher"], "desc": "Gopher - text-based browsing"},
        "79": {"services": ["finger"], "desc": "Finger - user info lookup"},
        "80": {"services": ["http"], "desc": "HTTP - web traffic"},
        "88": {"services": ["kerberos"], "desc": "Kerberos - network authentication"},
        "104": {"services": ["dicom"], "desc": "DICOM - medical imaging"},
        "109": {"services": ["pop2"], "desc": "POP2 - legacy email"},
        "110": {"services": ["pop3"], "desc": "POP3 - email retrieval"},
        "111": {"services": ["sunrpc", "rpcbind"], "desc": "Sun RPC/Portmapper"},
        "113": {"services": ["ident"], "desc": "Ident - user identification"},
        "119": {"services": ["nntp"], "desc": "NNTP - Usenet news"},
        "123": {"services": ["ntp"], "desc": "NTP - clock synchronization"},
        "135": {"services": ["msrpc", "dce-rpc"], "desc": "MS-RPC/DCE-RPC - Windows RPC"},
        "137": {"services": ["netbios", "nbns"], "desc": "NetBIOS Name Service"},
        "138": {"services": ["netbios", "nbds"], "desc": "NetBIOS Datagram"},
        "139": {"services": ["netbios", "smb"], "desc": "NetBIOS Session/SMB"},
        "143": {"services": ["imap"], "desc": "IMAP - email access"},
        "161": {"services": ["snmp"], "desc": "SNMP - network monitoring"},
        "162": {"services": ["snmptrap"], "desc": "SNMP Trap - network alerts"},
        "177": {"services": ["xdmcp"], "desc": "XDMCP - X11 display manager"},
        "179": {"services": ["bgp"], "desc": "BGP - internet routing"},
        "194": {"services": ["irc"], "desc": "IRC - chat protocol"},
        "389": {"services": ["ldap"], "desc": "LDAP - directory services"},
        "427": {"services": ["slp"], "desc": "SLP - service discovery"},
        "443": {"services": ["https", "tls", "ssl", "quic"], "desc": "HTTPS - encrypted web (TLS/SSL/QUIC)"},
        "445": {"services": ["smb", "cifs"], "desc": "SMB/CIFS - Windows file sharing"},
        "464": {"services": ["kpasswd"], "desc": "Kerberos password change"},
        "465": {"services": ["smtps"], "desc": "SMTPS - secure email submission"},
        "500": {"services": ["ipsec", "isakmp", "ike"], "desc": "IPsec/IKE - VPN key exchange"},
        "502": {"services": ["modbus"], "desc": "Modbus - industrial control (ICS/SCADA)"},
        "512": {"services": ["rexec"], "desc": "Remote execution"},
        "513": {"services": ["rlogin"], "desc": "Remote login"},
        "514": {"services": ["syslog", "rsh"], "desc": "Syslog/Remote shell"},
        "515": {"services": ["lpd"], "desc": "LPD - line printer daemon"},
        "520": {"services": ["rip"], "desc": "RIP - routing protocol"},
        "521": {"services": ["ripng"], "desc": "RIPng - IPv6 routing"},
        "546": {"services": ["dhcpv6-client"], "desc": "DHCPv6 client"},
        "547": {"services": ["dhcpv6-server"], "desc": "DHCPv6 server"},
        "548": {"services": ["afp"], "desc": "AFP - Apple file sharing"},
        "554": {"services": ["rtsp"], "desc": "RTSP - streaming media control"},
        "563": {"services": ["nntps"], "desc": "NNTPS - secure Usenet"},
        "587": {"services": ["smtp", "submission"], "desc": "Email submission (STARTTLS)"},
        "623": {"services": ["ipmi"], "desc": "IPMI - server management"},
        "631": {"services": ["ipp", "cups"], "desc": "IPP/CUPS - printing"},
        "636": {"services": ["ldaps"], "desc": "LDAPS - secure directory"},
        "646": {"services": ["ldp"], "desc": "LDP - MPLS label distribution"},
        "655": {"services": ["tinc"], "desc": "Tinc VPN"},
        "853": {"services": ["dns", "dot"], "desc": "DNS over TLS (DoT)"},
        "860": {"services": ["iscsi"], "desc": "iSCSI - network storage"},
        "873": {"services": ["rsync"], "desc": "Rsync - file synchronization"},
        "902": {"services": ["vmware"], "desc": "VMware ESXi"},
        "903": {"services": ["vmware"], "desc": "VMware remote console"},
        "989": {"services": ["ftps-data"], "desc": "FTPS data (TLS)"},
        "990": {"services": ["ftps"], "desc": "FTPS control (TLS)"},
        "992": {"services": ["telnets"], "desc": "Telnet over TLS"},
        "993": {"services": ["imaps"], "desc": "IMAPS - secure email access"},
        "995": {"services": ["pop3s"], "desc": "POP3S - secure email retrieval"},
        # Registered ports (1024-49151)
        "1080": {"services": ["socks"], "desc": "SOCKS proxy"},
        "1194": {"services": ["openvpn"], "desc": "OpenVPN"},
        "1352": {"services": ["lotus-notes"], "desc": "Lotus/HCL Notes"},
        "1433": {"services": ["mssql", "tds"], "desc": "Microsoft SQL Server"},
        "1434": {"services": ["mssql"], "desc": "MS SQL Browser"},
        "1494": {"services": ["citrix", "ica"], "desc": "Citrix ICA"},
        "1521": {"services": ["oracle"], "desc": "Oracle Database"},
        "1701": {"services": ["l2tp"], "desc": "L2TP VPN"},
        "1723": {"services": ["pptp"], "desc": "PPTP VPN"},
        "1812": {"services": ["radius"], "desc": "RADIUS authentication"},
        "1813": {"services": ["radius"], "desc": "RADIUS accounting"},
        "1883": {"services": ["mqtt"], "desc": "MQTT - IoT messaging"},
        "1900": {"services": ["ssdp", "upnp"], "desc": "SSDP/UPnP discovery"},
        "1935": {"services": ["rtmp"], "desc": "RTMP - Flash streaming"},
        "1985": {"services": ["hsrp"], "desc": "HSRP - router redundancy"},
        "2049": {"services": ["nfs"], "desc": "NFS - Unix file sharing"},
        "2055": {"services": ["netflow"], "desc": "NetFlow - traffic monitoring"},
        "2123": {"services": ["gtp-c"], "desc": "GTP-C - mobile signaling"},
        "2152": {"services": ["gtp-u"], "desc": "GTP-U - mobile data"},
        "2181": {"services": ["zookeeper"], "desc": "ZooKeeper coordination"},
        "2375": {"services": ["docker"], "desc": "Docker API (unencrypted)"},
        "2376": {"services": ["docker-ssl"], "desc": "Docker API (TLS)"},
        "2379": {"services": ["etcd"], "desc": "etcd client"},
        "2380": {"services": ["etcd"], "desc": "etcd peer"},
        "2404": {"services": ["iec-60870"], "desc": "IEC 60870-5-104 (SCADA)"},
        "2598": {"services": ["citrix"], "desc": "Citrix session reliability"},
        "3000": {"services": ["grafana"], "desc": "Grafana/Node.js apps"},
        "3128": {"services": ["squid"], "desc": "Squid HTTP proxy"},
        "3260": {"services": ["iscsi"], "desc": "iSCSI target"},
        "3306": {"services": ["mysql"], "desc": "MySQL database"},
        "3389": {"services": ["rdp"], "desc": "RDP - Windows remote desktop"},
        "3478": {"services": ["stun", "turn"], "desc": "STUN/TURN - NAT traversal"},
        "3690": {"services": ["svn"], "desc": "Subversion"},
        "3702": {"services": ["wsd"], "desc": "WS-Discovery"},
        "3724": {"services": ["blizzard", "wow"], "desc": "Blizzard/World of Warcraft"},
        "3868": {"services": ["diameter"], "desc": "Diameter - LTE/telecom auth"},
        "4500": {"services": ["ipsec"], "desc": "IPsec NAT-T"},
        "4789": {"services": ["vxlan"], "desc": "VXLAN overlay network"},
        "4840": {"services": ["opc-ua"], "desc": "OPC UA (industrial)"},
        "5000": {"services": ["upnp"], "desc": "UPnP/Docker Registry"},
        "5060": {"services": ["sip"], "desc": "SIP - VoIP signaling"},
        "5061": {"services": ["sip-tls"], "desc": "SIP over TLS"},
        "5222": {"services": ["xmpp"], "desc": "XMPP/Jabber chat"},
        "5223": {"services": ["xmpp-tls"], "desc": "XMPP over TLS"},
        "5353": {"services": ["mdns"], "desc": "mDNS - Bonjour/Avahi"},
        "5355": {"services": ["llmnr"], "desc": "LLMNR - local name resolution"},
        "5432": {"services": ["postgresql"], "desc": "PostgreSQL database"},
        "5672": {"services": ["amqp"], "desc": "AMQP - RabbitMQ"},
        "5683": {"services": ["coap"], "desc": "CoAP - IoT protocol"},
        "5900": {"services": ["vnc"], "desc": "VNC - remote desktop"},
        "5938": {"services": ["teamviewer"], "desc": "TeamViewer"},
        "5984": {"services": ["couchdb"], "desc": "CouchDB"},
        "5985": {"services": ["winrm"], "desc": "WinRM - Windows remote mgmt"},
        "6379": {"services": ["redis"], "desc": "Redis database"},
        "6443": {"services": ["kubernetes"], "desc": "Kubernetes API"},
        "6514": {"services": ["syslog-tls"], "desc": "Syslog over TLS"},
        "6556": {"services": ["checkmk"], "desc": "Checkmk monitoring"},
        "6667": {"services": ["irc"], "desc": "IRC chat"},
        "6697": {"services": ["irc-ssl"], "desc": "IRC over TLS"},
        "6881": {"services": ["bittorrent"], "desc": "BitTorrent"},
        "7000": {"services": ["cassandra"], "desc": "Cassandra inter-node"},
        "7001": {"services": ["weblogic"], "desc": "WebLogic"},
        "8000": {"services": ["http-alt"], "desc": "HTTP alternate"},
        "8080": {"services": ["http-proxy"], "desc": "HTTP proxy/alternate"},
        "8086": {"services": ["influxdb"], "desc": "InfluxDB"},
        "8123": {"services": ["home-assistant"], "desc": "Home Assistant"},
        "8332": {"services": ["bitcoin"], "desc": "Bitcoin RPC"},
        "8333": {"services": ["bitcoin"], "desc": "Bitcoin P2P"},
        "8443": {"services": ["https-alt"], "desc": "HTTPS alternate"},
        "8883": {"services": ["mqtt-tls"], "desc": "MQTT over TLS"},
        "9000": {"services": ["php-fpm"], "desc": "PHP-FPM"},
        "9042": {"services": ["cassandra"], "desc": "Cassandra CQL"},
        "9090": {"services": ["prometheus"], "desc": "Prometheus monitoring"},
        "9092": {"services": ["kafka"], "desc": "Apache Kafka"},
        "9200": {"services": ["elasticsearch"], "desc": "Elasticsearch REST"},
        "9300": {"services": ["elasticsearch"], "desc": "Elasticsearch transport"},
        "9418": {"services": ["git"], "desc": "Git protocol"},
        "9987": {"services": ["teamspeak3"], "desc": "TeamSpeak 3"},
        "10050": {"services": ["zabbix-agent"], "desc": "Zabbix agent"},
        "10051": {"services": ["zabbix-server"], "desc": "Zabbix server"},
        "11211": {"services": ["memcached"], "desc": "Memcached"},
        "15672": {"services": ["rabbitmq"], "desc": "RabbitMQ management"},
        "25565": {"services": ["minecraft"], "desc": "Minecraft Java"},
        "27015": {"services": ["steam"], "desc": "Steam/Source games"},
        "27017": {"services": ["mongodb"], "desc": "MongoDB"},
        "30303": {"services": ["ethereum"], "desc": "Ethereum P2P"},
        "32400": {"services": ["plex"], "desc": "Plex Media Server"},
        "44818": {"services": ["ethernet-ip"], "desc": "EtherNet/IP (industrial)"},
        "47808": {"services": ["bacnet"], "desc": "BACnet (building automation)"},
        "51820": {"services": ["wireguard"], "desc": "WireGuard VPN"},
        "64738": {"services": ["mumble"], "desc": "Mumble voice chat"},
    }
    for port, extras in arkime_extras.items():
        if port not in port_info:
            port_info[port] = {"services": [], "descriptions": [], "transports": set()}
        for svc in extras["services"]:
            if svc not in port_info[port]["services"]:
                port_info[port]["services"].append(svc)
        if extras["desc"] not in port_info[port]["descriptions"]:
            port_info[port]["descriptions"].insert(0, extras["desc"])
